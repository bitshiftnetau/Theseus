...
#define CMU_21MHZ_TUNE_ADDR ((unsigned long*)0x0FE081E0)
  ...
  #define DEFAULT_BOOT_TUNE CMU_1MHZ_TUNE_ADDR
#endif
#ifdef DEFAULT_HFRCO_7MHZ
  #define DEFAULT_BOOT_TUNE CMU_7MHZ_TUNE_ADDR
#endif
#ifdef DEFAULT_HFRCO_11MHZ
  #define DEFAULT_BOOT_TUNE CMU_11MHZ_TUNE_ADDR
#endif
#ifdef DEFAULT_HFRCO_14MHZ
  #define DEFAULT_BOOT_TUNE CMU_14MHZ_TUNE_ADDR
#endif
#ifdef DEFAULT_HFRCO_21MHZ
  #define DEFAULT_BOOT_TUNE CMU_21MHZ_TUNE_ADDR
#endif
